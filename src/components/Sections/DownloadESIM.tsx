...
export const DownloadESIM = () => {
  return (
    <div className="relative  text-dark-solid xl:h-[770px]  mb-10 ">
      <div className="xl:absolute mx-auto w-full xl:h-[830px] h-[700px] bg-homepage-background1 xl:bg-contain bg-cover bg-center bg-no-repeat xl:z-[-1] top-0 left-[-300px]"></div>

      <div className="md:w-[670px] xl:mt-0 mt-10 w-full xl:pt-[260px] 2xl:ml-[850px] xl:mr-[50px] mx-auto flex flex-col gap-[18px]">
