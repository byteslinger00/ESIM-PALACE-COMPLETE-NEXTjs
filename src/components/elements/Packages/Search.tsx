...
export const Search = () => {
    return (
        <div className="max-w-[650px] lg:w-full mx-auto gap-10 flex flex-row rounded-lg px-3 py-2 lg:bg-white bg-[#F2B21B]">
            <input
                type='text'
                placeholder="Type in the first letters of the country / region you are looking for?"
                className="px-3 outline-none grow text-[18px] text-[#828282] max-lg:hidden"
            />
