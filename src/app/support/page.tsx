...
export default function Page() {
  ...
  return (
    <main className="mt-[100px] relative">
      ...
      <Section1 heading={support.SectionHeader0} description={support.SectionDescription0} handlesearch={handleSearch}/>
      <Section2 heading={support.SectionHeader1} description={support.SectionDescription1} only_description={true} on_search={on_search} searchValue={searchValue}/>
      <Section3 />
    </main>
  );
}
