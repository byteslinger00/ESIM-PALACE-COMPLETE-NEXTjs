...
export const support = {
    ...
    title0: "How to install and activate an eSim on an iPhone?",
    description0: "Yes, you can. You can store several eSIM profiles in your phone, but you need to choose only one that will be active along with your primary physical SIM. So, the dual SIM functionality means having 1: Your primary physical SIM, and 2: One of your stored eSIM profiles active at the same time.",
}
